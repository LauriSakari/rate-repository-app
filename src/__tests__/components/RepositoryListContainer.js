...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        const [firstStars, firstForks, firstReviews, firstRatings] = within(firstRepositoryItemNumbers).getAllByTestId('numberRow')

        const [secondStars, secondForks, secondReviews, secondRatings] = within(secondRepositoryItemNumbers).getAllByTestId('numberRow')
